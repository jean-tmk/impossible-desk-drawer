...
function startDrag(e){
  const el=e.currentTarget,box=contents.getBoundingClientRect(),r=el.getBoundingClientRect();drag={el,box,dx:e.clientX-r.left,dy:e.clientY-r.top,startX:e.clientX,startY:e.clientY};window.addEventListener("pointermove",moveDrag);window.addEventListener("pointerup",endDrag,{once:true});tone(260,.05);
}
function moveDrag(e){
